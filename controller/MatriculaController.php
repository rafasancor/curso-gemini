...
use App\Dal\AlunoDao; // Needed to get student names
use App\Dal\CursoDao; // Needed to get course names
use App\View\Admin\MatriculaView; // New view for admin CRUD operations
