...
class Aluno {
    ...
    private string $dataNascimento; // YYYY-MM-DD format
    ...
    public static function criarAluno(
        ...
        // Basic CPF validation (e.g., format XXX.XXX.XXX-XX)
        ...
        if (!\DateTime::createFromFormat('Y-m-d', $dataNascimento) && !\DateTime::createFromFormat('d/m/Y', $dataNascimento)) {
            throw new \Exception("Formato de data de nascimento inválido. Use YYYY-MM-DD ou DD/MM/YYYY.");
        }
